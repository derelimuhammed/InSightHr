...
{
    public class OrganizationUpdateValidator:AbstractValidator<OrganizationUpdateVm>
    {
     ...
     .Must(date => date >= DateTime.Now.AddDays(-3)).WithMessage("Sözleşme başlangıç tarihi geçmiş bir tarih olamaz.");
        ...
        private bool BeAValidFile(IFormFile file)
        {
            ...
            // Dosya türü ve boyutu gibi özel koşulları burada kontrol edebilirsiniz.
            // Örnek olarak, sadece belirli dosya uzantılarını veya belirli bir boyutu kabul edebilirsiniz.
